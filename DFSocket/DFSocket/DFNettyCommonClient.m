...
-(void) setStatus:(CONNECTION_STATUS)status
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSDictionary *dic = [NSDictionary dictionaryWithObject:[NSNumber numberWithInt:_status] forKey:kStatus];
        [[NSNotificationCenter defaultCenter] postNotificationName:kNotifyStatus object:nil userInfo:dic];
